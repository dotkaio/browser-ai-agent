...
const SidePanel = () => {
  ...
  return (
    <div>
      <div
        className={`flex h-screen flex-col ${isDarkMode ? 'bg-slate-900' : 'bg-slate-50'} overflow-hidden border ${isDarkMode ? 'border-slate-700' : 'border-slate-300'} rounded-2xl`}>
          ...
          <div className="header-logo">
            {showHistory ? (
              <button
                ...
                className={`${isDarkMode ? 'text-slate-300 hover:text-slate-200' : 'text-slate-600 hover:text-slate-800'} cursor-pointer`}
            ...
            {!showHistory && (
              <>
                <button
                  ...
                  className={`header-icon ${isDarkMode ? 'text-slate-300 hover:text-slate-200' : 'text-slate-600 hover:text-slate-800'} cursor-pointer`}
            ...
            {hasConfiguredModels === false && (
              <div
                ...
                <div className="max-w-md text-center">
                  <h3 className={`mb-2 text-lg font-semibold ${isDarkMode ? 'text-slate-200' : 'text-slate-700'}`}>
                    {t('welcome_title')}
                  </h3>
